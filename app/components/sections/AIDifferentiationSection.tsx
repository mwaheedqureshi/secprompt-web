...
import { CheckCircle2, Brain, Database } from 'lucide-react';
  ...
  const cards = [
    {
      ...
      description: 'Collect and normalize security assertions across RFPs, SOC 2 reports, and compliance documents',
      color: 'from-blue-500 to-blue-600',
    },
    {
      icon: CheckCircle2,
      title: 'Independent Evidence',
      description: 'Cross-reference claims against third-party certifications, public registries, and operational telemetry',
      color: 'from-emerald-500 to-emerald-600',
    },
    {
      icon: Brain,
      title: 'Operational Proof',
      description: 'Reason across policies, reports, certificates, and evidence artifacts to validate what is actually supported',
      ...
      <div className="relative z-10 mx-auto max-w-6xl">
        ...
        >
          <p className="mb-4 text-sm font-semibold uppercase tracking-widest text-secondary-400">
            The Third-Party Risk Difference
          </p>
          <h2 className="text-4xl md:text-5xl font-bold text-white">
            Traditional TPRM tools collect answers.
            <br />
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary-400 to-secondary-400">
              SecPrompt verifies them.
            </span>
          </h2>
        </motion.div>
        ...
        >
          <p className="text-gray-400 text-lg mb-6">
            Every supplier assessment becomes a verified, audit-ready risk decision
          </p>
          <motion.div
          ...
          >
            ...
            <span className="text-sm font-medium">AI verification in real-time</span>
          </motion.div>
        </motion.div>
      </div>
    </section>
